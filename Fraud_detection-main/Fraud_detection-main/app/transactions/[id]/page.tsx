        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-lg">{transaction.riskScore}%</p>
            </div>
            
            <div>
              <p className="text-sm text-muted-foreground">Risk Level</p>
              <p>{transaction.riskLevel}</p>
            </div>
            
            <div>
              <p className="text-sm text-muted-foreground">Decision</p>
              <p className="font-semibold">{transaction.decision}</p>
            </div>
          ...
          {transaction.featureSnapshot && (
            <div className="mt-6">
              <h2 className="text-xl font-semibold mb-3">Feature Snapshot</h2>
              <pre className="bg-muted p-4 rounded-lg overflow-auto">
                {JSON.stringify(transaction.featureSnapshot, null, 2)}
              </pre>
            </div>
          )}
        </div>
